...
6. Memberikan komentar bahwa akan dilakukan pertukaran posisi.
7. Menyimpan nilai sementara ke variabel temp.
8. Memindahkan nilai dari indeks kanan ke kiri.
9. Menempatkan nilai temp ke posisi kanan.
10. 
11. 
